...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	{
	case WM_CREATE:
		hr = CoCreateInstance(CLSID_MulDiv, NULL, CLSCTX_INPROC_SERVER, IID_IMultiplication, (void**)&pIMultiplication);
		if (FAILED(hr))
		{
			MessageBox(NULL, TEXT("IMultiplication Interface didn't obtained"), TEXT("COM ERROR"), MB_ICONERROR);
			DestroyWindow(hwnd);
		}
		MessageBox(NULL, TEXT("IMultiplication Interface obtained"), TEXT("COM SUCCESS"), MB_ICONINFORMATION);
		//init var
		iNum1 = 55;
		iNum2 = 51;
